		...
		<div class="content-wrapper">
			...
			<section class="content-header">
				<div class="container-fluid">
					<div class="row mb-2">
						<div class="col-sm-6">
							<h1>Edit Product GoturthinQs<span style="color:red;">.</span></h1>
						</div>
					</div>
				</div><!-- /.container-fluid -->
			</section>
											...
											<div class="card-body">
												...
												<div class="form-group">
													...
													<input type="text" name="nama_produk" class="form-control" id="name" placeholder="Enter Name"
														autocomplete="off" required maxlength="100" value="<?= $product['nama_produk'];?>">
												</div>
												...
												<div class="form-group">
													...
													<select id="type" class="form-control" name="jenis_produk" required style="cursor:pointer;">
														...
														<option <?php if($type['jenis_produk']==$product['jenis_produk']){
								echo"selected";
												...
												<div class="form-group " id="colSize">
													...
													<select id="inputState" class="form-control" name="ukuran" required>
														...
														<option value="<?= $size['ukuran'];?>" <?php if($size['ukuran']==$product['ukuran']){
								echo"selected";
							} ?>><?= $size['ukuran']; ?></option>
														<?php endforeach; ?>
													</select>

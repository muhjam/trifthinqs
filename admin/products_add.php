...
$code=$jumlah_barang+1;

// jenis produk
$types=query("SELECT * FROM jenis_produk");

// ukuran produk
$sizes=query("SELECT * FROM ukuran");
							...
							<div class="card">
								<div class="card-header">
									<div class="card card-dark">
										<div class="card-header">
											<h3 class="card-title">Input New Product</h3>
										</div>
										<!-- /.card-header -->
										<!-- form start -->
										<form action="products_add_function.php" enctype="multipart/form-data" method="post">
											<div class="card-body">
												<div class="form-group d-none">
													<label for="code">Code</label>
													<input type="text" name="kode_produk" class="form-control" placeholder="Enter Code" id="code"
														value="KGB<?= $code;?>" readonly autocomplete="off" required>
												</div>

												<div class="form-group">
													<label for="name">Name</label>
													<input type="text" name="nama_produk" class="form-control" id="name" placeholder="Enter Name"
												...
												<div class="form-group">
													...
													<select id="type" class="form-control" name="jenis_produk" required style="cursor:pointer;">
														...
														<option value="<?= $type['jenis_produk'];?>">
															<?= $type['jenis_produk']; ?></option>
														<?php endforeach; ?>
													</select>
												</div>

												<div class="form-group d-none" id="colSize">
													<label for="size">Size</label>
													<select id="size" class="form-control" name="ukuran" required style="cursor:pointer;">
												...
												<div class="form-group">
													...
													<input type="text" name="harga" class="form-control" placeholder="Enter Price"
														id="dengan-rupiah" maxlength="16" required>
												</div>

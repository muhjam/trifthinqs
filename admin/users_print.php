...
// koneksi database
require 'query.php';
$user=query("SELECT * FROM users WHERE level='user' AND status='on' OR level='user' AND status='ban' OR level='admin' AND status='on' OR level='admin' AND status='ban' ORDER BY id DESC");
...
<body>
			...
			<i style="text-align: center;font-family: "Libre Bodoni", sans-serif;color: #151e3d;">Users of TrifthinQs Store<span style=" color: red;font-size: 50px;">.</span></i>
...
<table  border="1" cellpadding="10" cellspacing="0">
				<thead>
					<tr style="background-color:black;">
						...
						<th style="color:white;">Notlp</th>
						<th style="color:white;">Gender</th>
						<th style="color:white;">Birth</th>

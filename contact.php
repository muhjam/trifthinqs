...
<html lang="en">
	...
	<body>
		...
		<section id="contact">
			...
			<div class="contact">
				<form action="assets/php/send.php" method="post" name="Trifthinqs-contact-form">
					<div class="row">
						<div class="col">
					...
					<div class="row">
						<div class="col">
							<label for="gmail"><i class="fas fa-envelope"></i></label>
							<input type="email" id="gmail" name="email" placeholder="Email" required onkeyup="inputKeyup()">
						</div>
					</div>
					...
					<div class="row">
						<div class="col button">
							...
							<button type="reset" name="cancel" class="cancel">Cancel</button>
						</div>
					</div>
				</form>
			</div>
